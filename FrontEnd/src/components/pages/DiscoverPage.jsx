    ...
    <div className="max-w-screen-xl mx-auto">
        ...
        <main className="px-4 sm:px-8 md:px-16 mt-12 mb-20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                <div className="text-sm font-semibold text-gray-800">Mission Statement</div>
                <div className="md:col-span-1"></div>
                <div className="text-sm font-semibold text-gray-800 md:text-right">Search Artist or event</div>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-16 text-center text-gray-700">
                <div className="flex items-center">
                    <GlobeIcon />
                    <span>Discover Events happening near you or in whichever country</span>
                </div>
                <div className="flex items-center">
                    <GlobeIcon />
                    <span>Discover artist Nearby or around the globe</span>
                </div>
            </div>
